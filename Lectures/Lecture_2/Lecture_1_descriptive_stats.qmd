...
format: 
        ...
        revealjs:
                ...
                footer: "UH POLS3316, Spring 2026, Instructor: Tom Hanna <img src='../../assets/logo.png' alt='UH Logo' style='height:30px;'>"
---
...
library(here)
here::i_am("Lectures/Lecture_2/Lecture_1_descriptive_stats.qmd")
```
...
![Negatively skewed, Normal, and Positively Skewed distributions](`r here("assets", "skewed-curves.png")`)
