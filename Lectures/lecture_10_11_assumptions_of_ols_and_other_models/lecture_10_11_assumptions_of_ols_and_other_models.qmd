...
![Residual plot showing a U-shaped pattern, indicating nonlinearity](residual_plot_nonlinearity.jpg){fig-alt="Residual plot showing a U-shaped pattern, indicating nonlinearity"}
...
![Residual plot showing a clear pattern over time, indicating autocorrelation](non-independence.png){fig-alt="Residual plot showing a clear pattern over time, indicating autocorrelation"}
...
![Residual plot showing a fanning pattern, indicating heteroskedasticity](homoskedasticity.png){fig-alt="Residual plot showing a fanning pattern, indicating heteroskedasticity"}
...
![Normality of residuals around the OLS regression line demonstrated with normal curves at several points](normality.jpg){fig-alt="Normality of residuals around the OLS regression line demonstrated with normal curves at several points"}
...
![Perfect multicollinearity example: two good predictors compared to two highly correlated](multicollinearity.png){fig-alt="Perfect multicollinearity example: two predictors perfectly correlated"}
...
![Examples of continuous vs binary and count](ols_assumption_7_1.png){fig-alt="Examples of different outcome types: binary, count"}
...
![OLS line through binary data showing impossible predictions, contrasted with logistic S-curve](ols_to_MLE.png){fig-alt="OLS line through binary data showing impossible predictions, contrasted with logistic S-curve"}
